...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function()
		...
		end, { buffer = true, desc = "[F]ind [D]ebug Info" })
		vim.keymap.set("n", "<leader>ft", function()
			Snacks.debug.backtrace()
		end, { buffer = true, desc = "[F]ind [T]race" })
	end,
})
